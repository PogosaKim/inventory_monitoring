...
<div class="container-fluid">
	...
	<nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
		...
		<div class="d-flex align-items-center">
			...
			</div><a class="navbar-brand" href="{{URL::to('finance/index')}}">
		...
		<input type="hidden" name="_token" value="{{{ csrf_token() }}}" />
            ...
            <div class="card-body">
              <div class="row flex-between-center">
                <div class="col-md">
                  <h5 class="mb-2 mb-md-0">Welcome Back Finance!</h5>
                </div>
              </div>
            </div>
          </div>
...
function checkStatusRequest() {
    $.get('finance/check_status_request').then(function(res) {
            ...
            $.each(res.check_status_request, function(index, item) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
						window.location.href = "{{ url('finance/new_request_data') }}";
                    }
                });
            });
        }
