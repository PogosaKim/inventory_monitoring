...
$(document).ready(function() {
  ...
  oTable = $("#requestTable").DataTable({
      ajax: {
          url: "{{ url('finance/new_get_request') }}",
          type: "GET",
          data: function(d) { 
          },
          dataSrc: "",
    ...
    oTable.on("click", ".viewDetail", function() {
        ...
        const url = "{{ url('finance/my_request_data_form') }}?request_supplies_id=" + request_supplies_id + "&request_supplies_code=" + request_supplies_code;
        window.open(url);
    });
