...
$(document).ready(function() {
  ...
  oTable = $("#requestTable").DataTable({
      ajax: {
          url: "{{ url('pc/for_po_release_data') }}",
          type: "GET",
          data: function(d) { 
          },
          dataSrc: "",
    ...
    oTable.on("click", ".viewDetail", function() {
        ...
        const url = "{{ url('pc/my_request_po_data_form') }}?request_supplies_id=" + request_supplies_id + "&request_supplies_code=" + request_supplies_code;
        window.open(url);
    });
