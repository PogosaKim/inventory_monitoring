<table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;">
    <tr>
        <td bgcolor="#f8f9fa" style="padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px; color: #333333;">Items Ready for Pickup</h1>
    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 20px;">
            ...
            <p style="margin: 15px 0 5px 0; font-size: 14px; color: #666666;">Status: {{ $statusMessage }}</p>
            <p style="margin: 15px 0 5px 0; font-size: 14px; color: #666666;">Please visit the custodian office to pick up your items.</p>
