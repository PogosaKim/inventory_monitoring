<table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;">
    ...
    <tr>
        <td bgcolor="#f8f9fa" style="padding: 20px; text-align: center;">
            <h1 style="margin: 0; font-size: 24px; color: #333333;">Purchase Record Request Approved</h1>
    ...
    <tr>
        <td bgcolor="#ffffff" style="padding: 20px;">
            <h3 style="font-size: 18px; color: #333333; margin: 0 0 15px 0; font-weight: bold;">Approved Purchase Details</h3>
            <table width="100%" cellpadding="5" cellspacing="0" border="1" style="border-collapse: collapse;">
                <thead>
                    <tr bgcolor="#f1f3f5">
                        <th style="padding: 10px; font-size: 14px; color: #333333; text-align: left;">Item Name</th>
                        <th style="padding: 10px; font-size: 14px; color: #333333; text-align: left;">Quantity Requested</th>
            ...
            <p style="margin: 15px 0 5px 0; font-size: 14px; color: #666666;">Your purchase record request has been approved by the finance team.</p>
