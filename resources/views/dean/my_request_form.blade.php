            ...
            <form id="teacherRequestForm" style="margin: 20px;">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-2 text-center">
                        ...
                        @if (!empty($my_request_supplies_details->signature))
                            <img src="{{ asset($my_request_supplies_details->signature) }}" alt="HR Signature" 
                                 style="width: 100%; height: auto; margin-bottom: 10px;">
                        @else
                            <p>No signature available</p>
                        @endif
                        <b>{{ $my_request_supplies_details->last_name }}, {{ $my_request_supplies_details->first_name }} {{ $my_request_supplies_details->middle_name }}</b>
